...
class SystemTestsConfiguration:
    ...
    def __init__(self):
        ...
        self.locationWhereWeRunMake = os.getenv('VCAST_DEMO_SRC_BASE')
        ...
        self.locationWhereWeRunTests = self.locationWhereWeRunMake
        ...
        self.masterListOfTestCases = [TestCase('Steak'),TestCase('_SequenceTest'),TestCase('AddFreeDessert')]
