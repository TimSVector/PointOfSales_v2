...
git checkout HEAD %VCAST_DEMO_SRC_BASE%\vcast-workarea\vc_manage\PointOfSales_Manage.vcm %VCAST_DEMO_SRC_BASE%\order_entry\src\manager.c %VCAST_DEMO_SRC_BASE%\encrypt\src\encrypt.c %~1
git clean -fxd %VCAST_DEMO_SRC_BASE%\vcast-workarea\vc_manage\PointOfSales_Manage

%VECTORCAST_DIR%\manage -p %VCAST_DEMO_SRC_BASE%\vcast-workarea\vc_manage\PointOfSales_Manage --status
%VECTORCAST_DIR%\manage -p %VCAST_DEMO_SRC_BASE%\vcast-workarea\vc_manage\PointOfSales_Manage --disable --compiler TRUST_ZONE
%VECTORCAST_DIR%\manage -p %VCAST_DEMO_SRC_BASE%\vcast-workarea\vc_manage\PointOfSales_Manage --disable --compiler VectorCAST_MinGW_C++_ST
%VECTORCAST_DIR%\manage -p %VCAST_DEMO_SRC_BASE%\vcast-workarea\vc_manage\PointOfSales_Manage --disable --compiler VectorCAST_MinGW_C++17
%VECTORCAST_DIR%\manage -p %VCAST_DEMO_SRC_BASE%\vcast-workarea\vc_manage\PointOfSales_Manage --config VCAST_COVERAGE_SOURCE_FILE_PERSPECTIVE=FALSE

if "%~1"=="" (
    echo  1.  Build and execute the original project
    %VECTORCAST_DIR%\manage -p %VCAST_DEMO_SRC_BASE%\vcast-workarea\vc_manage\PointOfSales_Manage --build-execute --jobs 12
    ...
    %VECTORCAST_DIR%\manage -p %VCAST_DEMO_SRC_BASE%\vcast-workarea\vc_manage\PointOfSales_Manage --export-result result_r1.vcr
