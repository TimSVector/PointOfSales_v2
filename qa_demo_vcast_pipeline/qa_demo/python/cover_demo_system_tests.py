...
class SystemTestsConfiguration:
    def __init__(self):
        ...
        self.environmentVariables = {'PATH': os.pathsep.join([os.environ['VECTORCAST_DIR']+ r'/MinGW/bin', os.environ['PATH']])}

        # This is the path to where the build or make command should be executed
        #self.locationWhereWeRunMake = r'D:\work\Presale\demo\c-2021\live\wd\cover_demo'
        self.locationWhereWeRunMake = os.environ['demo_cover_src']

        # This is the top level make command needed to build the application
        self.topLevelMakeCommand = r'gcc -g -o manager_driver whitebox.c database.c manager.c manager_driver.c'

        # This is the location where we should run the tests.
        #self.locationWhereWeRunTests = r'D:\work\Presale\demo\c-2021\live\wd\cover_demo'
        self.locationWhereWeRunTests = os.environ['demo_cover_src']
