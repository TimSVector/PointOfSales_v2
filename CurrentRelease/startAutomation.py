...
of what automation command to run
    ...
    - build a demo manage projct using the command: $VECTORCAST_DIR/vpython vcdb2vcm.py
...
def solicitChoice():
    ...
    print '   (2) Remove a previously built VectorCAST Project'
...
def main():
    ...
    if args.interactive:
        ...
        # toolbar mode starts an Analytics dashboard for the current project
        ...
        # enterprise mode builds a manage project, add the environment script, and builds the environment
