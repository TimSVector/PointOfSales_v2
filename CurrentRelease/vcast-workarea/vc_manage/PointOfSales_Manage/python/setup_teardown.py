...
for VectorCAST/Manage tests. To use this feature:
  1. Create a class that implements the "setup" and "teardown" methods of the
     Target class below.
  2. Add the Target subclass along with Manage Project's Compiler Node Name
     as an entry to the compiler_name_to_target_mapping dict.
  3. Reload the Manage Project (the Project must be reloaded whenever this
     script is modified).

VectorCAST/Manage will run the provided "setup" method before running tests,
...
in your VectorCAST/Manage Project and the Target class derivative
...
# This call creates the association between this script and Manage ...
