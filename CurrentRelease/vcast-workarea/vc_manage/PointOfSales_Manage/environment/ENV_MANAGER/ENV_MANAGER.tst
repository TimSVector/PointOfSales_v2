...
(E) @LINE: 331 19)
    ...
    >>> Read:     "19)" 
(E) @LINE: 332 TEST.VALUE:manager.Place_Order.Order.Entree:FISH
...
TEST.IMPORT_FAILURES:
(E) @LINE: 307 TEST.VALUE:manager.Place_Order.Order.Entree:FISH
    >>> Value for 'Enumeral' out of range
    >>>   Read "FISH"
    >>>   Command Ignored
(E) @LINE: 308 TEST.EXPECTED:uut_prototype_stubs.Update_Record.Data.Order[1].Entree:FISH
    >>> Value for 'Enumeral' out of range
    >>>   Read "FISH"
    >>>   Command Ignored
TEST.END_IMPORT_FAILURES:
