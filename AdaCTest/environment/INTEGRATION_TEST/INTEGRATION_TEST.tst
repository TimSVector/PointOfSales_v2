...
TEST.END_NOTES:
TEST.STUB:manager.Get_Check_Total
...
-- Test Case: main.AddFreeDessert
TEST.UNIT:manager_driver
TEST.SUBPROGRAM:main
TEST.NEW
TEST.NAME:main.AddFreeDessert
TEST.VALUE:manager_driver.main.argc:2
TEST.VALUE:manager_driver.main.argv:<<malloc 2>>
TEST.VALUE:manager_driver.main.argv[0]:<<malloc 9>>
TEST.VALUE:manager_driver.main.argv[0]:"post.exe"
TEST.VALUE:manager_driver.main.argv[1]:<<malloc 15>>
TEST.VALUE:manager_driver.main.argv[1]:"AddFreeDessert"
TEST.END

-- Test Case: main.GetCheckTotal
TEST.UNIT:manager_driver
TEST.SUBPROGRAM:main
TEST.NEW
TEST.NAME:main.GetCheckTotal
TEST.VALUE:manager_driver.main.argc:2
TEST.VALUE:manager_driver.main.argv:<<malloc 2>>
TEST.VALUE:manager_driver.main.argv[0]:<<malloc 9>>
TEST.VALUE:manager_driver.main.argv[0]:"post.exe"
TEST.VALUE:manager_driver.main.argv[1]:<<malloc 14>>
TEST.VALUE:manager_driver.main.argv[1]:"GetCheckTotal"
TEST.END

-- Test Case: main.PlaceOrder
TEST.UNIT:manager_driver
TEST.SUBPROGRAM:main
TEST.NEW
TEST.NAME:main.PlaceOrder
TEST.VALUE:manager_driver.main.argc:2
TEST.VALUE:manager_driver.main.argv:<<malloc 2>>
TEST.VALUE:manager_driver.main.argv[0]:<<malloc 9>>
TEST.VALUE:manager_driver.main.argv[0]:"post.exe"
TEST.VALUE:manager_driver.main.argv[1]:<<malloc 11>>
TEST.VALUE:manager_driver.main.argv[1]:"PlaceOrder"
TEST.END
